  ...
  <div className="relative h-10 w-full min-w-[200px] flex">
    <input
     ...
     onChange={(e) => setSearchQuery(e.target.value)}
      ...
      className=" bg-slate-50 peer h-full w-full rounded-lg rounded-r-none border-solid-black border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#FF444A] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
      placeholder=" "
    />
